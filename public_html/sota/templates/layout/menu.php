...
<aside class="main-sidebar sidebar-dark-primary elevation-4 text-sm">
    ...
    <a class="brand-link" href="index.php">
        <img class="brand-image" src="../../../assets/images/logosota1.png" alt="<?= $setting['tenvi'] ?>">
    </a>

    <!-- Sidebar -->
    <div class="sidebar">
        <nav class="mt-3">
            <ul data-accordion="true" class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm"
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                ?>
                                        ...
                                        <li class="nav-item <?= $none ?>">
                                            <a class="nav-link <?= $active ?>" href="index.php?com=product&act=man&type=<?= $k ?>"
                                                title="<?= $v['title_main'] ?>"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                <p><?= $v['title_main'] ?></p>
                                            </a>
                                        </li>
                                        ...
                                        <?php if (isset($v['size']) && $v['size'] == true) {
                                            ...
                                            <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>"
                                                    href="index.php?com=product&act=man_size&type=<?= $k ?>" title="Kích thước"><i
                                                        class="nav-icon text-sm far fa-caret-square-right"></i>
                                                    <p>Kích thước</p>
                                                </a></li>
                                        <?php } ?>
                                        <?php if (isset($v['dungtich']) && $v['dungtich'] == true) {
                                            ...
                                            <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>"
                                                    href="index.php?com=product&act=man_dungtich&type=<?= $k ?>" title="Dung tích"><i
                                                        class="nav-icon text-sm far fa-caret-square-right"></i>
                                                    <p>Dung tích</p>
                                                </a></li>
                                        <?php } ?>
                                        <?php if (isset($v['dvt']) && $v['dvt'] == true) {
                                            ...
                                            <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>"
                                                    href="index.php?com=product&act=man_dvt&type=<?= $k ?>" title="Xuất xứ"><i
                                                        class="nav-icon text-sm far fa-caret-square-right"></i>
                                                    <p>Đơn vị tính</p>
                                                </a></li>
                                        <?php } ?>
                                        ...
                                        <?php if (isset($v['price']) && $v['price'] == true) {
                                            ...
                                            <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>"
                                                    href="index.php?com=product&act=man_price&type=<?= $k ?>" title="Danh mục hãng"><i
                                                        class="nav-icon text-sm far fa-caret-square-right"></i>
                                                    <p>Khoản giá</p>
                                                </a></li>
                                        <?php } ?>
                                        ...
                                        <?php if (isset($v['import_price']) && $v['import_price'] == true) {
                                            ...
                                            <li class="nav-item <?= $none ?>">
                                                <a class="nav-link <?= $active ?>" href="index.php?com=import_price&act=man&type=<?= $k ?>"
                                                    title="import"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                    <p>Cập nhật giá</p>
                                                </a>
                                            </li>
                                ...
                                <?php if (isset($value['photo_static'])) {
                                    foreach ($value['photo_static'] as $k) {
                                        ...
                                        <li class="nav-item <?= $none ?>">
                                            <a class="nav-link <?= $active ?>" href="index.php?com=photo&act=photo_static&type=<?= $k ?>"
                                                title="<?= $v['title_main'] ?>"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                <p><?= $v['title_main'] ?></p>
                                            </a>
                                        </li>
                                ...
                                ?>
                                    <li class="nav-item <?= $none ?>">
                                        <a class="nav-link <?= $active ?>" href="index.php?com=seopage&act=capnhat&type=<?= $k ?>"
                                            title="SEO page <?= $v['title_main'] ?>"><i
                                                class="nav-icon text-sm far fa-caret-square-right"></i>
                                            <p>SEO page <?= $v['title_main'] ?></p>
                                        </a>
                                    </li>
                                <?php } ?>
                            </ul>
                            ...
                            <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <?php if (isset($v['size']) && $v['size'] == true) {
                                        ...
                                        if ($com == 'product' && ($act == 'man_size' || $act == 'add_size' || $act == 'edit_size') && $k == $_GET['type']) $active = "active"; ?>
                                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>"
                                                href="index.php?com=product&act=man_size&type=<?= $k ?>" title="Danh mục kích thước"><i
                                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                                <p>Kích thước</p>
                                            </a></li>
                                    <?php } ?>
                                    <?php if (isset($v['doday']) && $v['doday'] == true) {
                                        ...
                                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>"
                                                href="index.php?com=product&act=man_doday&type=<?= $k ?>" title="Danh mục Độ dày"><i
                                                    class="nav-icon text-sm far fa-caret-square-right"></i>
                                                <p>Độ dày</p>
                                            </a></li>
                                    <?php } ?>
                ...
                <?php if (isset($config['places']['active']) && $config['places']['active'] == true) { ?>
                    ...
                    <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            ?>
                            <li class="nav-item <?= $none ?>">
                                <a class="nav-link <?= $active ?>" href="index.php?com=places&act=man_street" title="Đường"><i
                                        class="nav-icon text-sm far fa-caret-square-right"></i>
                                    <p>Đường</p>
                                </a>
                            </li>
                ...
                <?php } ?>
                <?php
                $active_ticket = ($com == 'ticket') ? 'active' : '';
                ?>
                <li class="nav-item">
                    <a href="index.php?com=ticket&act=man" class="nav-link <?= $active_ticket ?>">
                ...
                <?php if ($config['copright']['huongdan'] != '') { ?>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= $config['copright']['huongdan'] ?>" target="_blank"
                ...
                <li class="nav-item has-treeview">
                    <a class="nav-link active" href="#" title="Tài khoản admin">
                        <i class="nav-icon text-sm fas fa-users"></i>
                        <p>
                            Tài khoản admin
                            <i class="right fas fa-angle-left"></i>
                    ...
                    <ul class="nav nav-treeview" style="display: none;">
                        <li class="nav-item"><a class="nav-link " href="index.php?com=user&amp;act=admin_edit"
                                title="Thông tin admin"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Thông tin admin</p>
                            </a></li>
